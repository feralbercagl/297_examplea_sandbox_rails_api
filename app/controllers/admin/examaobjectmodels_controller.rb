class Admin::ExamaobjectmodelsController < AdminController
  ...
  def index
    ...
    @examaobjectmodels = V3::Examaobjectmodel.order_by([:id,:asc]).skip(page * PER_PAGE).limit(PER_PAGE)
  ...
  def show
    ...
    @examaobjectmodel = V3::Examaobjectmodel.find(params[:id])
  ...
  def create
    @examaobjectmodel = V3::Examaobjectmodel.new(params[:examaobjectmodel], as: :"System Admin")
    respond_to do |format|
