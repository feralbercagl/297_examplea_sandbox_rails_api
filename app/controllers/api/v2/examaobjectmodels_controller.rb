class Api::V2::ExamaobjectmodelsController < Api::ApiController
  resource_description do
    name 'V2::Examaobjectmodels'
    short 'V2::Examaobjectmodels'
    path '/v1/examaobjectmodels.json'
    version '2'
    formats ['json']
    param :id, String, :desc => "V2::Examaobjectmodel ID", :required => false
    param :examaobjectmodel, Hash, :desc => "V2::Examaobjectmodel parameters for all methods" do
  ...
  api :GET, "/v2/examaobjectmodels.json", "Show all examaobjectmodels based on a query scope"
  def index
  ...
  api :GET, "/v2/examaobjectmodels/:id.json", "Show examaobjectmodel"
  def show
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :GET, "/v2/examaobjectmodels/new.json", "Instantiate a new examaobjectmodel"
  def new
    @examaobjectmodel = V2::Examaobjectmodel.new
    respond_with @examaobjectmodel
  end

  # POST /examaobjectmodels.json
  api :POST, "/v2/examaobjectmodels.json", "Create a new examaobjectmodel"
  def create
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :PUT, "/v2/examaobjectmodels/:id.json", "Update an existing examaobjectmodel"
  def update
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :DELETE, "/v2/examaobjectmodels/:id.json", "Delete an existing examaobjectmodel"
  def destroy
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  include Api::V2::Custom::ExamaobjectmodelsController
end
