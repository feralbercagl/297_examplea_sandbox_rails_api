class Api::V3::ExamaobjectmodelsController < Api::ApiController
  resource_description do
    name 'V3::Examaobjectmodels'
    short 'V3::Examaobjectmodels'
    path '/v1/examaobjectmodels.json'
    version '3'
    formats ['json']
    param :id, String, :desc => "V3::Examaobjectmodel ID", :required => false
    param :examaobjectmodel, Hash, :desc => "V3::Examaobjectmodel parameters for all methods" do

      param :id, String, :required => true,
      :desc => "id"

      param :creation_date, Date, :required => true,
      :desc => "creation_date"
  ...
  api :GET, "/v3/examaobjectmodels.json", "Show all examaobjectmodels based on a query scope"
  def index
  ...
  api :GET, "/v3/examaobjectmodels/:id.json", "Show examaobjectmodel"
  def show
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :GET, "/v3/examaobjectmodels/new.json", "Instantiate a new examaobjectmodel"
  def new
    @examaobjectmodel = V3::Examaobjectmodel.new
    respond_with @examaobjectmodel
  end

  # POST /examaobjectmodels.json
  api :POST, "/v3/examaobjectmodels.json", "Create a new examaobjectmodel"
  def create
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :PUT, "/v3/examaobjectmodels/:id.json", "Update an existing examaobjectmodel"
  def update
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  api :DELETE, "/v3/examaobjectmodels/:id.json", "Delete an existing examaobjectmodel"
  def destroy
    reject_as_unauthorized and return if requires_authentication? and !authenticated?
  ...
  include Api::V3::Custom::ExamaobjectmodelsController
end
