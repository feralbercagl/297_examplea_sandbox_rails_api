...
class V1::ExamaobjectmodelAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @examaobjectmodel = V1::Examaobjectmodel.new({:creation_date=>"2014-12-18", :name=>"Omar Kuhic"}, as: :"System Admin")

    @examaobjectmodel.save

    @examaobjectmodel = V1::Examaobjectmodel.new({:creation_date=>"2014-12-18", :name=>"Maryanna Ferry"}, as: :"System Admin")
  ...
  test "should be able to create instance of examaobjectmodel" do
    ...
    fill_in "examaobjectmodel_name", :with => "Genaro Turcotte"
