...
class V3::ExamaobjectmodelAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @examaobjectmodel = V3::Examaobjectmodel.new({:creation_date=>"2014-12-19", :name=>"Jaimie Morissette"}, as: :"System Admin")

    @examaobjectmodel.save

    @examaobjectmodel = V3::Examaobjectmodel.new({:creation_date=>"2014-12-19", :name=>"Hiedi Gleason"}, as: :"System Admin")
  ...
  test "should be able to create instance of examaobjectmodel" do
    ...
    fill_in "examaobjectmodel_creation_date", :with => "2014-12-19"

    fill_in "examaobjectmodel_name", :with => "Bruce Herzog"
